...
public class MedidasConLluviaDetectadaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_medidas_con_lluvia_detectada, container, false);
    }
    ...
    private void initialize () {
        ...
        Call<List<Data>> call = service.getDatosLluviaDetectada();
